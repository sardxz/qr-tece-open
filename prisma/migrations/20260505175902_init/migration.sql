...
-- CreateEnum
CREATE TYPE "MemberRole" AS ENUM ('MEMBER', 'MOD', 'OWNER');

-- CreateEnum
CREATE TYPE "DepoStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
CREATE TABLE "Depo" (
    ...
    "status" "DepoStatus" NOT NULL DEFAULT 'PENDING',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Depo" ADD CONSTRAINT "Depo_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Depo" ADD CONSTRAINT "Depo_recipientId_fkey" FOREIGN KEY ("recipientId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
